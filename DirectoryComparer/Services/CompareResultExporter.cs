...
namespace DirectoryComparer.Services
{
    ...
    public static class CompareResultExtensions
    {
        ...
        public static string ToCsv(this CompareResult compareResult)
        {
            ...
            return string.Format(description, compareResult.GetFileOrFolderName(), compareResult.LeftFilePath, compareResult.RightFilePath, compareResult.Match, compareResult.LeftCreatedDate.ToString(), compareResult.RightCreatedDate.ToString(), compareResult.LeftModifiedDate.ToString(), compareResult.RightModifiedDate.ToString());
        }
